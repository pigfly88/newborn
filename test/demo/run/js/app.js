/*! running-money-frontend - v1.0.0 - 2015-05-09 */
!function (a, b) {
    function c(a) {
        return function (b) {
    ...
    k = function () {
        var a, b, c, d, e, i = 0, j = {};
        if ("wp" === f("fr"))
            for (c = f("uc_param_str"), e = c.length - c.length % 2; e > i;)
                d = c.substr(i, 2), j[d] = f(d), i += 2;
    ...
    function d(a, b, c, d, f, g) {
        var h = "";
        if (e())
            d && (d = d.replace("SinaWeibo", "kSinaWeibo"), d = d.replace("WechatFriends", "kWeixin"), d = d.replace("WechatTimeline", "kWeixinFriend")), ucbrowser.web_share(a, b, c, d || "", "", "", f || "");
        else
            try {
    ...
    function d(b) {
        this.startFrame = -1, this.frames = b, this.render = function (a, b) {
            ...
            var d = this;
            d.frame = c, d.el = {}, d.el.$root = b, d.wWin = window.innerWidth, d.hWin = window.innerHeight, d.img = {src: f.RESOURCE[1], num: d.frames.length, idx: d.getFrame(c), w: 125, h: 275};
    ...
    d.canvas = e.$("#can-game"), d.FPS = f.FPS[0], d.frame = 0, d.timer = g.requestAnimationFrame || g.webkitRequestAnimationFrame || g.setTimeout, d.playing = !1, d.buffer = null, d.animateList = c.exports.animateList = [], c.exports.initCanvas = d.initCanvas = function () {
        ...
        for (var a = 0, b = d; a < b.animateList.length;)
            b.animateList[a].render(b.buffer, b.frame), ++a
    }, d.render = function () {
    ...
    "use strict";
    function d(a) {
        this.startFrame = -1, this.framesImg = f.RESOURCE[0], this.frameSize = {w: 288, h: 315}, this.frames = a, this.render = function (a, b) {
    ...
    d.curGrade = 1,
        ...
        e.once("game/setup", function () {
            ...
            g.init([
                {q: "#g-ready", bg: "url(../public/images/game.png) center -200px no-repeat", bgSize: "225px 245px"},
                {q: ".g-finger dt", bg: "url(../public/images/game.png) no-repeat center top", bgSize: "225px 245px"},
                {q: ".g-finger dd", bg: "url(../public/images/game.png) no-repeat center -100px", bgSize: "225px 245px"}
        ...
        function a() {
            m.playCheer(), e.$("#page-game").removeEventListener("touchstart", a)
        }
    ...
    d.gradeMap = f.GRADE_MAP, d.curType = 1, d.combo = 0, c.exports.run = d.run = function (a) {
        ...
        for (var b, c = d, e = c.combo, f = c.gradeMap, g = f.length; g--;)
            if (e >= f[g]) {
                b = g + 1;
                break
            }
    ...
    b.renderStart = function () {
        ...
        k.addClass(r, "sel");
        var a = 0, b = c.FRAMES_MAP.g1;
        e.render(l, a), new f(b).render(l, a), new g(b).render(l, a), j.render({ctx: l.getContext("2d"), src: c.RESOURCE[2], x: 166, w: 200, h: 250}), k.addClass(s, "sel-ani"), setTimeout(function () {
    ...
    d.observer = a("widget/observer"), d.start = function () {
        ...
        function a() {
            ...
            for (j.isOwner() && (j.bestDis = j.ownerInfo.dist); a--;)
                j.records[a].runnerUserId !== j.userInfo.userId || j.isOwner() || (j.curDis = j.records[a].dist)
        }
        ...
        g.$("#i-start").addEventListener("click", function () {
            ...
            d.closeDownload()
        }), g.$("#i-reward").addEventListener("click", function () {
            d.getReward()
        })
    }, d.setupObserver = function () {
        ...
        for (var a = i.PRE_RESOURCE.concat(i.RESOURCE), b = a.length; b--;)
            g.preImage(a[b])
    }
    ...
    d.renderStatic = function () {
        ...
        function b() {
            for (var a = j.records.sort(function (a, b) {
                ...
                c.push({type: 0, dist: a[b].dist, avatar: a[b].avatar}), ++b;
            return j.getRemain() > 0 && c.push({type: 1, avatar: f.NODE_AVATAR.next}), c.push({type: 2, avatar: f.NODE_AVATAR.reward}), c
        }
        ...
        function d(a, b) {
            for (var c = 0, d = b.length, f = e.createDocumentFragment(); d > c;)
                f.appendChild(h.node(b[c], c, j.getRemain())), ++c;
            a.appendChild(f)
        }
    ...
    function d() {
        this.curDis = 0, this.bestDis = 0, this.run = function (a, b) {
            ...
            this.curDis = a, this.curDis > this.bestDis && "others" !== i() ? (g.get("run", {token: m, time: h, finish: d()}, function (c) {
            ...
            for (var a = this.records.length, b = 0; a--;)
                b += this.records[a].dist;
            return b
    ...
    function p(a) {
        ...
        b.style.display = "none", b.src = o() ? "ucbrowser://" + a : "ucweb://|" + a, b.src.indexOf("fromCallUc") < 0 && (b.src += b.src.indexOf("?") < 0 ? "?fromCallUc=true" : "&fromCallUc=true"), u.body.appendChild(b)
    }
    ...
    c.exports = {$: d, preImage: e, trim: f, hasClass: g, addClass: h, removeClass: i, tMovePreDef: j, txtNull: k, checkPhone1700: l, checkPhone: m, checkTelPhone: n, isIOS: o, callUcbrowser: p, format: x, cancelBubble: q, isInputNull: r, once: s}
    ...
    c.exports = function () {
        e.isIOS() ? "wechat" === f() ? (h.emit("log", {page: "download", os: "ios"}), d.href = g.DOWNLOAD_URL.iosQQ) : (h.emit("log", {page: "download", os: "ios"}), d.href = g.DOWNLOAD_URL.iosStore) : "wechat" === f() ? (h.emit("log", {page: "download", os: "android"}), d.href = g.DOWNLOAD_URL.androidQQ) : (h.emit("log", {page: "download", os: "android"}), d.href = g.DOWNLOAD_URL.android)
    }
