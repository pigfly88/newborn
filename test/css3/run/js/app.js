...
}), define("images/tree", ["appData", "utils/utils"], function (a, b, c) {
    "use strict";
    function d(a) {
    ...
    d.curGrade = 1, d.observer = a("widget/observer"), d.needCalcul = !1, d.gameTime = i.GAME_TIME, d.interval = 100, d.dis = 0, d.started = !1, d.showUpGrade = !1, c.exports.start = d.start = function () {
        e.once("game/setup", function () {
            ...
            g.init([
                {q: "#g-ready", bg: "url(../images/game.png) center -200px no-repeat", bgSize: "225px 245px"},
                {q: ".g-finger dt", bg: "url(../images/game.png) no-repeat center top", bgSize: "225px 245px"},
                {q: ".g-finger dd", bg: "url(../images/game.png) no-repeat center -100px", bgSize: "225px 245px"}
